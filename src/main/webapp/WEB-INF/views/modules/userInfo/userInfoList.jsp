...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="userInfo:userInfo:edit"><li><a href="${ctx}/userInfo/userInfo/form">用户信息添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="userInfo">
			<tr>
				...
				<shiro:hasPermission name="userInfo:userInfo:edit"><td>
